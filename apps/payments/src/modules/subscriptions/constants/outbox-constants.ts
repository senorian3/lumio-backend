...
export enum OutboxEventType {
  ...
  UPDATE_SUBSCRIPTION_METADATA_STRIPE = 'subscription.update.metadata.stripe',
  ...
  FAILED_UPDATE_SUBSCRIPTION_METADATA_PROCESSING = 'failed.subscription.update.metadata.processing',
